...
def parse_vk_group(token: str, vk_account_id: int, proxy: str, vk_session) -> dict:
    vk_groups_data = get_vk_account_admin_groups(token, vk_account_id, proxy, vk_session)
